...
TEST_RUN = False
PARENT_URL = 'http://www.cvonline.lt/darbo-skelbimai/visi?page='
OUTPUT_FILENAME = "/jobad_scrape/data/" + timestamp_extension() + ".txt"
LOG_FILENAME = "/jobad_scrape/log/ads_log_cvonlinelt.txt"
...
while True:
    ...
    adDataRows = adContentExist(html, 'div', 'cvo_module_offer')
    if not adDataRows:
        # print break message
    ...
    adData = scrape_cvonlinelt(adDataRows)
    # writes to text file
